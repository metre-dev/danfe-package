                      ...
                      Padding(
                          ...
                          child: ElevatedButton(
                              onPressed: () async {
                                ...
                                await controller.printDefault(danfe: _dadosDanfe, paper: PaperSize.mm80, profile: profile);
                              },
                      ...
                      Padding(
                          ...
                          child: ElevatedButton(
                              onPressed: () async {
                                ...
                                await controller.printCustomLayout(danfe: _dadosDanfe, paper: PaperSize.mm80, profile: profile);
                              },
                      ...
                      Padding(
                          ...
                          child: ElevatedButton(
                              onPressed: () async {
                                ...
                                await controller.printImage(paper: PaperSize.mm80, profile: profile);
                              },
                              child: const Text('Imprimir minha customizacao'))),
                    ],
                  ),
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
            Center(child: Text(nota?.tipo == TipoDocumento.CFe ? ' Nota SAT' : 'Nota NFC-E')),
            Padding(
